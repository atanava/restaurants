...
public class Dish extends AbstractNamedEntity{
    ...
    public Dish(Dish d) {
        this(d.getId(), d.getRestaurant(), d.getName(), d.isEnabled(), d.isInMenu());
    }

    public Dish(Integer id, Restaurant restaurant, String name, boolean enabled, boolean isInMenu) {
        super(id, name);
